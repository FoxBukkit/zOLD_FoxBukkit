...
public abstract class Ini {
	...
	public static Map<String, List<Map<String, List<String>>>> load(String fileName) {
		...
		try {
			final BufferedReader stream = new BufferedReader(FoxBukkit.instance.configuration.makeReader(fileName));
			while (true) {
	...
	public static void save(String fileName, Map<String, List<Map<String, List<String>>>> sections) {
		try {
			final BufferedWriter stream = new BufferedWriter(FoxBukkit.instance.configuration.makeWriter(fileName));
