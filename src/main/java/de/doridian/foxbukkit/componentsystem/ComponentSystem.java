 ...
 */
package de.doridian.foxbukkit.componentsystem;
...
public class ComponentSystem {
	...
	public void registerComponents() {
		loadedComponents.put("advanced", new de.doridian.foxbukkit.advanced.Main());
		loadedComponents.put("fun", new de.doridian.foxbukkit.fun.Main());
