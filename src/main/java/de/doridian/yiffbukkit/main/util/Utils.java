...
import net.minecraft.server.v1_4_R1.v1_4_R1.Packet62NamedSoundEffect;
import net.minecraft.server.v1_4_R1.v1_4_R1.WatchableObject;
...
public class Utils {
	...
	public static void dumpDataWatcher(DataWatcher datawatcher) {
		for (Object o : datawatcher.c()) {
			net.minecraft.server.v1_4_R1.v1_4_R1.WatchableObject wo = (WatchableObject) o;
