...
public class ChannelCommand extends ICommand {
	private enum SubCommand {
		...
		CREATE, //yiffbukkitsplit.channels.create
		PASSWORD, MODERATOR, DROP, MODE, RANGE, //channel owner or yiffbukkitsplit.channels.force.owner
		KICK, USER, //moderator or yiffbukkitsplit.channels.force.moderator
		SWITCH, SAY, MUTE, SINGLE, LEAVE //users in channel or yiffbukkitsplit.channels.force.user
	}
