...
import net.minecraft.server.v1_5_R1.EntityEgg;
import net.minecraft.server.v1_5_R1.EntityEnderDragon;
import net.minecraft.server.v1_5_R1.EntityEnderPearl;
import net.minecraft.server.v1_5_R1.EntityEnderSignal;
import net.minecraft.server.v1_5_R1.EntityExperienceOrb;
...
public class MyEntityTypes {
	...
	public static final Class<? extends net.minecraft.server.v1_5_R1.Entity> typeNameToClass(String mobType) throws EntityTypeNotFoundException {
		for (Entry<String, Class<? extends net.minecraft.server.v1_5_R1.Entity>> entry : typeNameToClass.entrySet()) {
	...
	public static final int classToId(Class<? extends net.minecraft.server.v1_5_R1.Entity> mobType) throws EntityTypeNotFoundException {
	...
	public static final String classToTypeName(Class<? extends net.minecraft.server.v1_5_R1.Entity> mobType) throws EntityTypeNotFoundException {
	...
	public static final Class<? extends net.minecraft.server.v1_5_R1.Entity> idToClass(int id) throws EntityTypeNotFoundException {
		final Class<? extends net.minecraft.server.v1_5_R1.Entity> mobType = idToClass.get(id);
		if (mobType == null)
			throw new EntityTypeNotFoundException();
