...
import net.minecraft.server.v1_4_R1.v1_4_R1.MathHelper;
import net.minecraft.server.v1_4_R1.v1_4_R1.Packet18ArmAnimation;
import net.minecraft.server.v1_4_R1.v1_4_R1.Packet28EntityVelocity;
import net.minecraft.server.v1_4_R1.v1_4_R1.Packet30Entity;
import net.minecraft.server.v1_4_R1.v1_4_R1.Packet34EntityTeleport;
import net.minecraft.server.v1_4_R1.v1_4_R1.Packet38EntityStatus;
...
public abstract class EntityShape extends Shape {
	...
	public EntityShape(Transmute transmute, Entity entity, int mobType) {
		...
		try {
			Class<? extends net.minecraft.server.v1_4_R1.v1_4_R1.Entity> entityClass = ((CraftEntity) entity).getHandle().getClass();
