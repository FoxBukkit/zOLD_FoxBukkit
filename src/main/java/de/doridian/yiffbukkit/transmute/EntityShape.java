...
import net.minecraft.server.v1_4_6.v1_4_6.Packet38EntityStatus;
...
public abstract class EntityShape extends Shape {
	...
	public EntityShape(Transmute transmute, Entity entity, int mobType) {
		...
		try {
			Class<? extends net.minecraft.server.v1_4_6.v1_4_6.Entity> entityClass = ((CraftEntity) entity).getHandle().getClass();
