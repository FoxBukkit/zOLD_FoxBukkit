...
import net.minecraft.server.v1_4_5.v1_4_5.Packet38EntityStatus;
...
public abstract class EntityShape extends Shape {
	...
	public EntityShape(Transmute transmute, Entity entity, int mobType) {
		...
		try {
			Class<? extends net.minecraft.server.v1_4_5.v1_4_5.Entity> entityClass = ((CraftEntity) entity).getHandle().getClass();
