...
public class Transmute implements Runnable {
		...
		scheduler.scheduleSyncRepeatingTask(plugin, new Runnable() {
			...
			public void run() {
				...
				for (Iterator<Packet> iterator = transmutePacketListener.ignoredPackets.iterator(); iterator.hasNext(); ) {
					...
					if (((net.minecraft.server.v1_4_6.v1_4_6.Packet) packet).timestamp < minTimestamp)
						iterator.remove();
				}
	...
	public boolean isTransmuted(net.minecraft.server.v1_4_6.v1_4_6.Entity entity) {
	...
	public Shape getShape(net.minecraft.server.v1_4_6.v1_4_6.Entity entity) {
