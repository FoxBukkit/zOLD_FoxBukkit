...
@Permission("foxbukkit.teleport.noport.noport")
public class NoPortCommand extends ICommand {
	...
	public void Run(Player player, String[] args, String argStr, String commandName) throws FoxBukkitCommandException {
		...
		case "":
			...
			if (tpPermissions == null) {
				...
				throw new FoxBukkitCommandException("The states of notp and nosummon differ. Please use /noport on/off explicitly.");
			}
			break;
		...
		default:
			throw new FoxBukkitCommandException("Usage: " + getUsage());
		}
	...
	private void setException(Player player, String[] args, UUID playerName, UUID otherName, boolean allow) throws FoxBukkitCommandException {
		if (args.length < 2)
			throw new FoxBukkitCommandException("Usage: " + getUsage());

		if (otherName == null)
			throw new FoxBukkitCommandException("Sorry, multiple players found!");
	...
	private Collection<UUID> getExceptions(final UUID playerName) throws FoxBukkitCommandException {
