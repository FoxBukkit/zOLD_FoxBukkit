...
public class MyEntityTypes {
	...
	public static Class<? extends net.minecraft.server.v1_7_R4.Entity> typeNameToClass(String mobType) throws EntityTypeNotFoundException {
		for (Entry<String, Class<? extends net.minecraft.server.v1_7_R4.Entity>> entry : typeNameToClass.entrySet()) {
	...
	public static int classToId(Class<? extends net.minecraft.server.v1_7_R4.Entity> mobType) throws EntityTypeNotFoundException {
	...
	public static String classToTypeName(Class<? extends net.minecraft.server.v1_7_R4.Entity> mobType) throws EntityTypeNotFoundException {
	...
	public static Class<? extends net.minecraft.server.v1_7_R4.Entity> idToClass(int id) throws EntityTypeNotFoundException {
		final Class<? extends net.minecraft.server.v1_7_R4.Entity> mobType = idToClass.get(id);
		if (mobType == null)
			throw new EntityTypeNotFoundException();
