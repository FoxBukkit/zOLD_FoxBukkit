...
public class Redrum extends FBEffect {
	...
	public void runEffect() {
		...
		FoxBukkit.instance.playerHelper.sendPacketToPlayersAround(location, 32, new PacketPlayOutEntity.PacketPlayOutRelEntityMove(entity.getEntityId(), (byte) 0, (byte) 0, entz, false), except);
		paused = false;
